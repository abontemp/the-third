...
const [_topComment, _setTopComment] = useState('')
const [_flopComment, _setFlopComment] = useState('')
...
// Charger les profiles pour afficher les noms
...
const membersWithNames = profilesData?.map(profile => ({
  id: profile.id,
  user_id: profile.id,
